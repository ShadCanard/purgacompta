...
import { GET_VEHICLES } from '@lib/queries/vehicles';
...
import { DELETE_VEHICLE } from '@/lib/mutations/vehicles';
...
const VehiclesSettingsPage: React.FC = () => {
  ...
  if (isLoading) {
    ...
    content = <Typography color="error">Erreur lors du chargement des véhicules</Typography>;
  } else {
    content = (
      <TableContainer>
        <Table>
