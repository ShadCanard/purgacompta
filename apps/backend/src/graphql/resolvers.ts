...
// 		tabletUpdated: { subscribe: () => pubsub.asyncIterator(['TABLET_UPDATED']) },		
// 		storageUpdated: { subscribe: () => pubsub.asyncIterator(['STORAGE_UPDATED']) }
// 	},
// 	Mutation: {
// 		// VehicleUser CRUD
...
// 			// Récupère le stockage et l’item
...
// 			// Règle métier :
// 			// - Si armurerie, uniquement weapon=true
// 			// - Si stockage, weapon=false uniquement
...
// 			}
// 			// Ajout ou update de la quantité
// 			let result;
