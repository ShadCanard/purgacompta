...
CREATE TABLE "new_item_prices" (
    ...
    CONSTRAINT "item_prices_targetGroupId_fkey" FOREIGN KEY ("targetGroupId") REFERENCES "groups" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_item_prices" ("buying", "createdAt", "groupId", "id", "itemId", "onSell", "price", "updatedAt") SELECT "buying", "createdAt", "groupId", "id", "itemId", "onSell", "price", "updatedAt" FROM "item_prices";
